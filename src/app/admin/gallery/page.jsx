          ...
          <aside className="absolute right-0 top-0 h-full w-72 bg-white shadow-2xl flex flex-col">
            ...
            <nav className="p-3 space-y-1 flex-1 overflow-y-auto">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-3 bg-gradient-to-r from-green-500 to-green-400 text-white rounded-xl font-semibold hover:from-green-600 hover:to-green-500 transition shadow"
              >
