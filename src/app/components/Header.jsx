    ...
    <header className={headerClasses}>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative">
        <div className="flex items-center justify-between h-24">
          ...
          {/* لوگوی متنی ساده و جذاب - سمت راست */}
          <div className="flex items-center group cursor-pointer">
            <div className="relative">
              <h1 className="text-4xl font-black text-[#399918] tracking-wide leading-none relative">
                <span className="relative z-10 inline-block transition-all duration-300 group-hover:scale-105 drop-shadow-sm">
                  علم و هنر
                </span>
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              </h1>
              <p className="text-xs font-semibold text-gray-600 tracking-[0.2em] mt-1 text-right opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                SCIENCE & ART
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 space-x-reverse">
            ...
            {/* دکمه پشتیبانی با آیکون پیام */}
            <button className="hidden md:flex items-center justify-center w-12 h-12 bg-white/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl hover:bg-green-50 transition-all duration-300 group ring-2 ring-green-100 hover:ring-[#399918]/30 relative">
              <MessageCircle className="w-6 h-6 text-gray-600 group-hover:text-[#399918] transition-colors" />
              {/* نقطه آنلاین */}
            ...
            <button 
              ...
              className="hidden md:flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#399918] to-green-600 rounded-2xl shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 ring-2 ring-[#399918]/20 hover:ring-[#399918]/40"
            >
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-t border-gray-200/80 shadow-2xl">
          <div className="p-6">
            ...
            <div className="space-y-3 pt-4 border-t border-gray-200/80">
              <button className="w-full flex items-center justify-center py-4 bg-green-50 text-[#399918] rounded-xl font-bold hover:bg-green-100 transition-all duration-300">
              ...
              <div className="flex items-center justify-center space-x-3 space-x-reverse">
                ...
                <button 
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-[#399918] to-green-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  ورود
                </button>
                <button className="flex-1 py-4 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition-all duration-300">
                  ثبت نام
                </button>
              </div>
            </div>
